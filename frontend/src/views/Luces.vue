<template>
  <div class="space-y-6">
    <div class="flex items-center justify-between">
      <h1 class="text-2xl font-bold text-white">💡 Iluminación</h1>
      <div class="flex gap-2">
        <button @click="turnAllOn" class="btn-primary text-sm">
          ◉ Todo ON
        </button>
        <button @click="turnAllOff" class="btn-secondary text-sm">
          ◌ Todo OFF
        </button>
      </div>
    </div>
    ...
    <div class="glass-card p-6">
      <h2 class="text-lg font-semibold text-white mb-4">📍 Planta Alta</h2>
    ...
    <!-- Planta Baja -->
    <div class="glass-card p-6">
      <h2 class="text-lg font-semibold text-white mb-4">📍 Planta Baja</h2>
      <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
